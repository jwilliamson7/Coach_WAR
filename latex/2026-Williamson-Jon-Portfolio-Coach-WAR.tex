...
Play-by-play data is publicly available through nfl\_data\_py. Coaching history data was scraped from Pro Football Reference. Processed data and analysis code are available at \url{https://github.com/jwilliamson7/Coach_WAR} or upon request to the corresponding author. Raw salary cap data from Spotrac is proprietary but processing scripts are provided.
